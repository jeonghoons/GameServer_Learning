...
bool Session::RegisterConnect()
{
	...
	if (SocketUtils::BindAnyAddress(_socket, 0/*남는 주소&포트 연동*/) == false)
		return false;
...
void Session::ProcessRecv(int32 numOfBytes)
{
	...
	if (numOfBytes == 0)
	{
		DisConnect(L"Recv 0"); // Client가 나간경우(recv걸어줄 필요없고 ref 인상태)
		return;
	}
